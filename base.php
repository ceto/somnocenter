...
<body <?php body_class(); ?>>
  ...
  <!--[if lt IE 9]><div class="alert alert-warning"><?php _e('You are using an <strong>outdated</strong> browser. Please <a href="http://browsehappy.com/">upgrade your browser</a> to improve your experience.', 'roots'); ?></div><![endif]-->
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/hu_HU/sdk.js#xfbml=1&appId=1403698493245219&version=v2.0";
