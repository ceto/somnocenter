<?php if ( (!is_page_template('page-landing.php')) && (!is_page_template('page-orvosok.php')) && ($post->post_parent != '179') && (is_singular()) && (!is_page(2)) && (!is_page(43)) && (!is_page(53)) && (!is_front_page()) ) : ?>
